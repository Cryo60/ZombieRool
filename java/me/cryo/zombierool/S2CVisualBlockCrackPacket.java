...
public class S2CVisualBlockCrackPacket {
    private final BlockPos pos;
    private final int damageLevel; // 0-9 pour la texture de fissure

    public S2CVisualBlockCrackPacket(BlockPos pos, int damageLevel) {
        this.pos = pos;
        this.damageLevel = damageLevel;
    }

    public S2CVisualBlockCrackPacket(FriendlyByteBuf buffer) {
    ...
    public static void handle(S2CVisualBlockCrackPacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
