    ...
    public static void handle(SavePerksConfigMessage msg, Supplier<NetworkEvent.Context> ctxSupplier) {
        ...
        ctx.enqueueWork(() -> {
            ...
            if (be instanceof PerksLowerBlockEntity perksBE) {
                ...
                // Le block entity s'occupera d'appeler l'update au client et la maj visuelle via PerksLowerBlock
                me.cryo.zombierool.block.PerksLowerBlock.updatePerkType(world, msg.pos, msg.perkId);
            }
        });
