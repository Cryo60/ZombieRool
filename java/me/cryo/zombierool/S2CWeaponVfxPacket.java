...
public class S2CWeaponVfxPacket {
    ...
    public S2CWeaponVfxPacket(String vfxType, Vec3 start, Vec3 end, boolean isPap, boolean hitHeadshot) {
    ...
    public static void encode(S2CWeaponVfxPacket msg, FriendlyByteBuf buf) {
    ...
    public static S2CWeaponVfxPacket decode(FriendlyByteBuf buf) {
        return new S2CWeaponVfxPacket(
            buf.readUtf(),
    ...
    public static void handle(S2CWeaponVfxPacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
