// Dans net.mcreator.zombierool.block.entity.SpawnerDogBlockEntity.java
 ...
 */
public class SpawnerDogBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
    ...
    @Override public Component getDefaultName() { return Component.literal("spawner_dog"); }
    @Override public Component getDisplayName() { return Component.literal("Spawner Dog (comme ta mère)"); }
