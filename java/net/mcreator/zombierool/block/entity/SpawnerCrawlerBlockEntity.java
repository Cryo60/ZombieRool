 ...
 */
public class SpawnerCrawlerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
    ...
    @Override public Component getDefaultName() { return Component.literal("spawner_crawler"); }
    @Override public Component getDisplayName() { return Component.literal("Spawner Crawler"); }
