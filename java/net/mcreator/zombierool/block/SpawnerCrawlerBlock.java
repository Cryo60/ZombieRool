...
public class SpawnerCrawlerBlock extends Block implements EntityBlock {
    public SpawnerCrawlerBlock() {
    ...
    public void appendHoverText(ItemStack itemstack, BlockGetter world, List<Component> list, TooltipFlag flag) {
        ...
        list.add(Component.literal(getTranslatedMessage("§9Point d'Apparition des Crawlers", "§9Crawler Spawn Point")));
        list.add(Component.literal(getTranslatedMessage("§7Définit où les crawlers apparaîtront.", "§7Defines where crawlers will spawn.")));
        list.add(Component.literal(getTranslatedMessage("§7Canal actif par défaut : 0.", "§7Default active channel: 0.")));
        list.add(Component.literal(getTranslatedMessage("§7Les crawlers apparaissent moins souvent que les zombies.", "§7Crawlers spawn less frequently than zombies.")));
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new SpawnerCrawlerBlockEntity(pos, state);
    }
    ...
    public void onRemove(BlockState state, Level level, BlockPos pos, BlockState newState, boolean isMoving) {
        if (!level.isClientSide) {
            ...
            if (be instanceof SpawnerCrawlerBlockEntity szbe) { // Adaptez le type (SpawnerZombieBlockEntity, SpawnerCrawlerBlockEntity, SpawnerDogBlockEntity) selon le fichier
    ...
    public int getAnalogOutputSignal(BlockState blockState, Level world, BlockPos pos) {
        ...
        if (tileentity instanceof SpawnerCrawlerBlockEntity be)
